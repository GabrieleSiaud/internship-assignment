...
This repository contains the full project for the internship assignment — a fullstack web application with separate frontend and backend. It also has more games than there was indicated in the assigment for the website to look fuller. Additional games are: Minecraft, Grand Theft Auto V and Terraria Steam Gift.
